...
/*! This function finds the connected workflow in a graph stored in
    ...
    \note The cptr, cind, and cids parameters can be NULL, in which case 
          only the number of connected workflow is returned.
*/
/*************************************************************************/
